...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE pestcontrol SET ownerid=%s, invoiceno=%s, cname=%s, mobile=%s, services=%s, cps=%s, cpe=%s, tamount=%s, paidamount=%s, `date`=%s, `time`=%s WHERE sno=%s",
                       GetSQLValueString($_POST['ownerid'], "int"),
                       GetSQLValueString($_POST['invoiceno'], "text"),
                       GetSQLValueString($_POST['cname'], "text"),
                       GetSQLValueString($_POST['mobile'], "text"),
                       GetSQLValueString($_POST['services'], "text"),
                       GetSQLValueString($_POST['cps'], "text"),
  ...
  $updateGoTo = "pestcontrolbills.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_ebils, $ebils);
$query_Recordset1 = sprintf("SELECT * FROM pestcontrol WHERE sno = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="services" name="services" value="<?php echo $row_Recordset1['services']; ?>" required/>
                                    </div> 

                                 
                                   
<div class="col-md-6">
                                        <label>Contract Period Starts</label>
                                        <input class="form-control" placeholder="dd/mm/yyyy" name="cps" value="<?php echo $row_Recordset1['cps']; ?>" required/>
                                    </div>
<div class="col-md-6">
                                        <label>Contract Period Ends</label>
                                        <input class="form-control" placeholder="dd/mm/yyyy"  name="cpe" value="<?php echo $row_Recordset1['cpe']; ?>" required/>
                                    </div>
<div class="col-md-6">
