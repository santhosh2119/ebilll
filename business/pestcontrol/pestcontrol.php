...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  ...
  $insertSQL = sprintf("INSERT INTO pestcontrol (ownerid, invoiceno, cname, mobile, services, cps, cpe, tamount, paidamount, `date`, `time`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  ...
  $insertGoTo = "pestcontrolbills.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="services" name="services" required/>
                                    </div> 
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="dd/mm/yyyy" name="cps" required/>
                                    </div>
<div class="col-md-6">
                                        <label>Contract Period Ends</label>
                                        <input class="form-control" placeholder="dd/mm/yyyy"  name="cpe" required/>
                                    </div>
<div class="col-md-6">
