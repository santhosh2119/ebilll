                ...
                <div class="avatar">
                    <div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-6 col-xs-offset-3 text-center">
                        ...
                        <div class="col-md-8 col-md-offset-2" >
                                ...
                                <div class="row">
									   <div class="col-md-6">
                                        	<h5><strong> Name : </strong>  <?php echo $row_Recordset1['name']; ?></h5>
                                    </div>
									
									   <div class="col-md-6">
                                     <h5><strong> Mobile : </strong>  <?php echo $row_Recordset1['mobile']; ?></h5>
                                    </div>
									 <div class="col-md-6">
                                     <h5><strong> Shop Name : </strong>  <?php echo $row_Recordset1['businessname']; ?></h5>
                                    </div>
									 <div class="col-md-6">
                                     <h5><strong> City : </strong>  <?php echo $row_Recordset1['city']; ?></h5>
                                    </div>
									<div class="col-md-6">
                                     <h5><strong> District : </strong>  <?php echo $row_Recordset1['district']; ?></h5>
                                    </div>
									 <div class="col-md-6">
                                     <h5><strong> State : </strong>  <?php echo $row_Recordset1['state']; ?></h5>
                                    </div>
									 
									 <div class="col-md-6">
                                     <h5><strong> Pincode : </strong>  <?php echo $row_Recordset1['pincode']; ?></h5>
                                    </div>
									<div class="col-md-6">
                                     <h5><strong> GST : </strong>  <?php echo $row_Recordset1['GST']; ?></h5>
                                    </div>
										
                                <div class="row">
                                    <div class="col-md-4 col-md-offset-4">
                                      <a href="editprofile.php">  <button class="btn btn-danger btn-block btn-lg btn-fill">Edit Profile</button></a>
                                    </div>
                                </div>
