...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE photostudio SET ownerid=%s, invoiceno=%s, cname=%s, mobile=%s, eventname=%s, eventdate=%s, tamount=%s, paidamount=%s, `date`=%s, `time`=%s WHERE sno=%s",
  ...
  $updateGoTo = "photostudiobills.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_ebils, $ebils);
$query_Recordset1 = sprintf("SELECT * FROM photostudio WHERE sno = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="Event Name" name="eventname" value="<?php echo $row_Recordset1['eventname']; ?>" required/>
                                    </div> 
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="dd/mm/yyyy" name="eventdate" value="<?php echo $row_Recordset1['eventdate']; ?>" required/>
                                    </div>
