...
mysql_select_db($database_ebils, $ebils);
$query_Recordset1 = sprintf("SELECT * FROM photostudio WHERE (ownerid = %s AND invoiceno = $coln )", GetSQLValueString($colname_Recordset1, "int"));
...
<table cellpadding="0" cellspacing="0" >
            ...
            <tr class="item">
                ...
                <td><?php echo $row_Recordset1['eventname']; ?>
                </td>
            </tr>
