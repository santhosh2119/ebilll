...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO photostudio (ownerid, invoiceno, cname, mobile, eventname, eventdate, tamount, paidamount, `date`, `time`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  ...
  $insertGoTo = "photostudiobills.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="Event Name" name="eventname" required/>
                                    </div> 
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="dd/mm/yyyy" name="eventdate" required/>
                                    </div>
