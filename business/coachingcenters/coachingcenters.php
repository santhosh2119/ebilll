...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO coachingcenters (ownerid, invoiceno, cname, mobile, course, joindate, enddate, tamount, paidamount, `date`, `time`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  ...
  $insertGoTo = "coachingcentersbills.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="col-md-6">
                                        ...
                                        <input class="form-control" placeholder="Course Name" name="course" required/>
                                    </div> 
