                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h4 class="text-center">Promote Your Business <br>
@Ebils </h4>


 <div class="row">
                                     <div class="col-md-4 col-md-offset-4">
                                      <a href="imagepromotions.php" >    <button class="btn btn-danger btn-block btn-lg btn-fill">Image Promotions</button></a>
                                    </div>
                                </div> <br>
<div class="row">
                                    <div class="col-md-4 col-md-offset-4">
                                   <a href="messagepromotions.php" >       <button class="btn btn-danger btn-block btn-lg btn-fill">SMS Promotions </button></a>
                                    </div>
                                </div> 
...
<br>
							<div class="row">
                                    <div class="col-md-4 col-md-offset-4">
                                   <a href="Bannerpromotions.php" >       <button class="btn btn-danger btn-block btn-lg btn-fill">Banner Promotions </button></a>
                                    </div>
                                </div> 
