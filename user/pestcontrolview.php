...
$query_Recordset1 = "SELECT * FROM pestcontrol WHERE ( invoiceno = $invoice AND ownerid = $colname_Recordset1)";
...
mysql_select_db($database_ebils, $ebils);
$query_Recordset3 = sprintf("SELECT * FROM paidamount WHERE ownerid =  $colname_Recordset1 AND invoiceno= $invoice", GetSQLValueString($colname_Recordset3, "int"));
...
From:<br>
                               <strong><?php echo $row_Recordset2['businessname']; ?> .</strong><br> 
								<?php echo $row_Recordset2['city']; ?>,<?php echo $row_Recordset2['district']; ?>,<?php echo $row_Recordset2['state']; ?>,<?php echo $row_Recordset2['pincode']; ?>
                               <br><?php echo $row_Recordset2['mobile']; ?>
                           </td>
...
<table cellpadding="0" cellspacing="0" >
            ...
            <?php do { ?>
              ...
              <tr class="item">
                <td><?php echo $row_Recordset3['date']; ?><br><?php echo $row_Recordset3['time']; ?>
                </td>
...
<tr class="item">
      <td>
                ...
                <td>
					<strong>     <?php echo $row_Recordset1['paidamount']; ?>    </strong></td>
  </tr>
         ...
         <tr class="item">
                ...
                <td>
                <strong><?php echo $row_Recordset1['tamount'] - $row_Recordset1['paidamount']; ?><strong>
                </td>
            </tr>
<tr>
