...
<body>
 ...
 <li>
                ...
                <a href="pestcontrol.php" class="btn btn-simple"><i class="fa fa-plus"></i>Invoice</a>
            </li>           
 <li>
...
<li>
                <a href="promotions.php" class="btn btn-simple"><i class="fa fa-user-circle-o"></i>Promotions</a>
            </li>
          <li>
