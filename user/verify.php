...
$sql = "SELECT * FROM cusers where mobile =  '$mobile' ";
...
if ($result->num_rows === 0) {
        ...
        if ($result == true) {
          ...
          mysqli_query($con, "INSERT INTO uverify (mobile,otp_hash) VALUES( '" . $mobile_no . "', '" . $rand_opt . "')"); 
	...
	header("Location: existslogin.php"); 
    }
}
...
if (isset($_POST['otpverify'])) {
	...
	if($password != $cpassword) {
		...
		if (!$error) {
$sql = "SELECT * FROM uverify where mobile ='$mobile_no' AND otp_hash='$opt' ";
$result = $con->query($sql);
	
	
if ($result->num_rows === 1) {
    // output data of each row
 mysqli_query($con, "INSERT INTO cusers (mobile,password,dateofjoin) VALUES( '" . $mobile . "', '" . $pass . "','" . $date . "')");
