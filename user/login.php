...
if(isset($_SESSION['usr_id'])!="") {
	header("Location: promoviews.php");
}
...
if (isset ($_POST["login"])) {
	...
	$result = mysqli_query($con, "SELECT * FROM cusers WHERE  mobile = '" .$mobile. "' and password = '" . $pass . "'");
	...
	if ($row = mysqli_fetch_array($result)) {
		...
		$errormsg = "Incorrect Moobile or Password!!!";
	}
}
?>
...
<br>
                                    ...
                                    <a href="signup.php" class="btn btn-simple btn-danger" >Sign Up</a>
                                </div>
 <div class="forgot" align="center">
<br>
